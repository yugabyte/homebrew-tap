                    ...
                    class YbVoyagerAT172 < Formula
                        desc "YugabyteDB's migration tool"
                        homepage "https://github.com/yugabyte/yb-voyager/"
                        url "https://github.com/yugabyte/yb-voyager/archive/refs/tags/yb-voyager/v1.7.2.tar.gz"
                        sha256 "16ebe7dee1593420df242c18ce5a1cbdac3b00c39b65c5da0441a8dabd3961cd"
                        version "1.7.2"
                        license "Apache-2.0"
                        depends_on "go" => :build
                        depends_on "libpq"
                        depends_on "sqlite"
                        depends_on "yugabyte/tap/debezium@2.3.3-1.7.2"
