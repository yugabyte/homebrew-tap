class YbVoyagerAT184 < Formula
    desc "YugabyteDB's migration tool"
    homepage "https://github.com/yugabyte/yb-voyager/"
    url "https://github.com/yugabyte/yb-voyager/archive/refs/tags/yb-voyager/v1.8.4.tar.gz"
    sha256 "97f055135da9983422e2184bff18e091bbb184a28515c98ce9418ba0009e5843"
    version "1.8.4"
    license "Apache-2.0"
    depends_on "go" => :build
    depends_on "postgresql@16"
    depends_on "sqlite"
    depends_on "yugabyte/tap/debezium@2.5.2-1.8.4"
