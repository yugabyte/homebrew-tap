class YbVoyagerAT2025111 < Formula
    desc "YugabyteDB's migration tool"
    homepage "https://github.com/yugabyte/yb-voyager/"
    url "https://software.yugabyte.com/yugabyte/yb-voyager/archive/refs/tags/yb-voyager/brew/v2025.11.1.tar.gz"
    sha256 "ec03e51d26412d04d97fb82a2a0edbbbc618700bd35ebb42d6d66235ab203386"
    version "2025.11.1"
    license "Apache-2.0"
    depends_on "go@1.24" => :build
    depends_on "postgresql@17"
    depends_on "sqlite"
    depends_on "yugabyte/tap/debezium@2.5.2-2025.11.1"
