class YbVoyagerAT202622 < Formula
    desc "YugabyteDB's migration tool"
    homepage "https://github.com/yugabyte/yb-voyager/"
    url "https://software.yugabyte.com/yugabyte/yb-voyager/archive/refs/tags/yb-voyager/brew/v2026.2.2.tar.gz"
    sha256 "b15fb1b23382c461906e01fddd5aebbfe2bafd3fc87d21ca5cbfc81d2f5c489d"
    version "2026.2.2"
    license "Apache-2.0"
    depends_on "go@1.24" => :build
    depends_on "postgresql@17"
    depends_on "sqlite"
    depends_on "yugabyte/tap/debezium@2.5.2-2026.2.2"
