class YbVoyagerAT0rc1189 < Formula
    desc "YugabyteDB's migration tool"
    homepage "https://github.com/yugabyte/yb-voyager/"
    url "https://github.com/yugabyte/yb-voyager/archive/refs/tags/yb-voyager/v0rc1.1.8.9.tar.gz"
    sha256 "521c6ea06a931b59de78e00d98099b48a49b0b083a9c05f1df072175c6b67568"
    version "0rc1.1.8.9"
    license "Apache-2.0"
    depends_on "go" => :build
    depends_on "postgresql@17"
    depends_on "sqlite"
    depends_on "yugabyte/tap/debezium@0rc1.2.5.2-1.8.9"
