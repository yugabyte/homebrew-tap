class YbVoyagerAT0rc12025111 < Formula
    desc "YugabyteDB's migration tool"
    homepage "https://github.com/yugabyte/yb-voyager/"
    url "https://software.yugabyte.com/yugabyte/yb-voyager/archive/refs/tags/yb-voyager/brew/v0rc1.2025.11.1.tar.gz"
    sha256 "d3497de900dbdae967f239b447a535c0ed0e8b411b4d8c82af278e57511bea01"
    version "0rc1.2025.11.1"
    license "Apache-2.0"
    depends_on "go@1.24" => :build
    depends_on "postgresql@17"
    depends_on "sqlite"
    depends_on "yugabyte/tap/debezium@0rc1.2.5.2-2025.11.1"
