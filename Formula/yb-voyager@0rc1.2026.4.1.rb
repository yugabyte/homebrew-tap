class YbVoyagerAT0rc1202641 < Formula
    desc "YugabyteDB's migration tool"
    homepage "https://github.com/yugabyte/yb-voyager/"
    url "https://software.yugabyte.com/yugabyte/yb-voyager/archive/refs/tags/yb-voyager/brew/v0rc1.2026.4.1.tar.gz"
    sha256 "522bf32d1ff0c18b7e00a1823f2c8254bde6890ac9bca765d1f6eb86e0a784ec"
    version "0rc1.2026.4.1"
    license "Apache-2.0"
    depends_on "go@1.24" => :build
    depends_on "postgresql@17"
    depends_on "sqlite"
    depends_on "yugabyte/tap/debezium@0rc1.2.5.2-2026.4.1"
