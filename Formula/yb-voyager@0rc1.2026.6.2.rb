class YbVoyagerAT0rc1202662 < Formula
    desc "YugabyteDB's migration tool"
    homepage "https://github.com/yugabyte/yb-voyager/"
    url "https://software.yugabyte.com/yugabyte/yb-voyager/archive/refs/tags/yb-voyager/brew/v0rc1.2026.6.2.tar.gz"
    sha256 "204bef71a8d3e5644fcb86eb479b114c880a37e3b2b2f51256c89142313a1243"
    version "0rc1.2026.6.2"
    license "Apache-2.0"
    depends_on "go@1.24" => :build
    depends_on "postgresql@17"
    depends_on "sqlite"
    depends_on "yugabyte/tap/debezium@0rc1.2.6.2-2026.6.2"
