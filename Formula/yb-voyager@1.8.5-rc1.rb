class YbVoyagerAT185Rc1 < Formula
    desc "YugabyteDB's migration tool"
    homepage "https://github.com/yugabyte/yb-voyager/"
    url "https://github.com/yugabyte/yb-voyager/archive/refs/tags/yb-voyager/v1.8.5-rc1.tar.gz"
    sha256 "6e301447a112398fd5d9db5d631227853c5810444bd6a097664747ca57ddec57"
    version "1.8.5-rc1"
    license "Apache-2.0"
    depends_on "go" => :build
    depends_on "postgresql@16"
    depends_on "sqlite"
    depends_on "yugabyte/tap/debezium@2.5.2-1.8.5-rc1"
