class YbVoyagerAT0rc12025121 < Formula
    desc "YugabyteDB's migration tool"
    homepage "https://github.com/yugabyte/yb-voyager/"
    url "https://software.yugabyte.com/yugabyte/yb-voyager/archive/refs/tags/yb-voyager/brew/v0rc1.2025.12.1.tar.gz"
    sha256 "463930fa7ae08beb95695eaded1403fd1875942c49fa037eff63371f2be94177"
    version "0rc1.2025.12.1"
    license "Apache-2.0"
    depends_on "go@1.24" => :build
    depends_on "postgresql@17"
    depends_on "sqlite"
    depends_on "yugabyte/tap/debezium@0rc1.2.5.2-2025.12.1"
