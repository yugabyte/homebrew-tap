class YbVoyagerAT0rc1202682 < Formula
    desc "YugabyteDB's migration tool"
    homepage "https://github.com/yugabyte/yb-voyager/"
    url "https://software.yugabyte.com/yugabyte/yb-voyager/archive/refs/tags/yb-voyager/brew/v0rc1.2026.8.2.tar.gz"
    sha256 "3e8ca15ac6ce4232119ffc05baebed79b6a1dba53ebb271ce96136e7dc149ff0"
    version "0rc1.2026.8.2"
    license "Apache-2.0"
    depends_on "go@1.24" => :build
    depends_on "postgresql@17"
    depends_on "sqlite"
    depends_on "yugabyte/tap/debezium@0rc1.2.5.2-2026.8.2"
