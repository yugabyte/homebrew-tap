class YbVoyagerAT0rc1202631 < Formula
    desc "YugabyteDB's migration tool"
    homepage "https://github.com/yugabyte/yb-voyager/"
    url "https://software.yugabyte.com/yugabyte/yb-voyager/archive/refs/tags/yb-voyager/brew/v0rc1.2026.3.1.tar.gz"
    sha256 "59098e91f54c556728924565bd60af9769e5b298ad102f18448814c46566a703"
    version "0rc1.2026.3.1"
    license "Apache-2.0"
    depends_on "go@1.24" => :build
    depends_on "postgresql@17"
    depends_on "sqlite"
    depends_on "yugabyte/tap/debezium@0rc1.2.5.2-2026.3.1"
