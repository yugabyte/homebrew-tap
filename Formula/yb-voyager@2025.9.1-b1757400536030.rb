class YbVoyagerAT202591b1757400536030 < Formula
    desc "YugabyteDB's migration tool"
    homepage "https://github.com/yugabyte/yb-voyager/"
    url "https://github.com/yugabyte/yb-voyager/archive/refs/tags/yb-voyager/v2025.9.1-b1757400536030.tar.gz"
    sha256 "aeef019fb6a44833ec3086dce3b3e3be2ab0c7ec8a4e774a9d405bb2c9819523"
    version "2025.9.1-b1757400536030"
    license "Apache-2.0"
    depends_on "go" => :build
    depends_on "postgresql@17"
    depends_on "sqlite"
    depends_on "yugabyte/tap/debezium@2.5.2-2025.9.1-b1757400536030"
