class YbVoyagerAT0rc1202651 < Formula
    desc "YugabyteDB's migration tool"
    homepage "https://github.com/yugabyte/yb-voyager/"
    url "https://software.yugabyte.com/yugabyte/yb-voyager/archive/refs/tags/yb-voyager/brew/v0rc1.2026.5.1.tar.gz"
    sha256 "3e3f6c245e1e774ccdba7f55ee699e86e97fd5679d6d63c44d0f1e6300133967"
    version "0rc1.2026.5.1"
    license "Apache-2.0"
    depends_on "go@1.24" => :build
    depends_on "postgresql@17"
    depends_on "sqlite"
    depends_on "yugabyte/tap/debezium@0rc1.2.5.2-2026.5.1"
