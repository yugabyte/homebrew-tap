class YbVoyagerAT0rc1202661 < Formula
    desc "YugabyteDB's migration tool"
    homepage "https://github.com/yugabyte/yb-voyager/"
    url "https://software.yugabyte.com/yugabyte/yb-voyager/archive/refs/tags/yb-voyager/brew/v0rc1.2026.6.1.tar.gz"
    sha256 "cccc6169c1f67008121995c4aa0222c59cc8fafc119571e63d26e3814d062d86"
    version "0rc1.2026.6.1"
    license "Apache-2.0"
    depends_on "go@1.24" => :build
    depends_on "postgresql@17"
    depends_on "sqlite"
    depends_on "yugabyte/tap/debezium@0rc1.2.5.2-2026.6.1"
